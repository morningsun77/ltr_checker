...
def ltr(max_len_threshold,min_len_threshold,max_ltr, min_ltr,outputDir,tg_ca, TSD,dict,seq_id_file):
    if tg_ca:
        finder_filter = '1111'
    else:
        finder_filter = '0000'
...
if __name__ == '__main__':
    ...
    localresults = [pool.apply_async(ltr,args=[max_len_threshold,min_len_threshold,max_ltr,min_ltr,outputDir,tg_ca, TSD,ltr_seq,seq_id]) for seq_id in seq_id_file]
    pool.close()
    pool.join()
