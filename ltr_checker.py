...
from output_parser import parse_ltr_detector_output, parse_ltr_finder_output, parse_ltr_harvest_output, unify_outputs, generate_ltr_fasta, convert_to_ltr_detector_format, convert_to_ltr_finder_format, convert_to_ltr_harvest_format
...
parser.add_argument('--stride',type=int,required=False,default=10000,help="stride, default=10000")
...
if __name__ == '__main__':
    ...
    if software not in ["ltr_finder", "ltr_harvest", "ltrdetector", "all"]:
        print(f"Error: Unsupported software '{software}'. Please use 'ltr_finder', 'ltr_harvest', 'ltrdetector', or 'all'.")
        exit(1)
    ...
    # Annotate LTR-RTs with the selected software
    if software == "all":
        # Run all three software in sequence: ltr_finder -> ltr_harvest -> ltrdetector
        print("\n" + "="*50)
        print("Running all annotation software in sequence...")
        print("="*50)
        ...
        print("\n" + "="*50)
        print("All software completed successfully!")
        print("Output files:")
        ...
        run_ltr_annotation(threads, max_len_threshold, min_len_threshold, max_ltr, min_ltr, 
                        outputDir, tg_ca, TSD, ltr_seq, seq_id_file, software)
    
    # Generate LTR-RT FASTA file regardless of software or output format chosen
    print("\n" + "="*50)
