    ...
    def filter_candidates(self, input_fasta: str, output_fasta: str):
        ...
        with open(filter_log_path, "w") as filter_log:
            ...
            column_descriptions = [
                ...
                "# Sequence_ID: 序列标识符",
                "# Total_Length: 完整序列长度",
                "# Internal_Length: Internal region长度",
                "# LTR5_Length: 5' LTR长度",
                "# LTR3_Length: 3' LTR长度", 
                "# LTR_Internal_Ratio: LTR与internal region的长度比",
                "# Internal_Check: Internal region长度检查结果",
                "# Ratio_Check: LTR:internal比率检查结果",
                "# Gap_Check: Gap检查结果",
                "# Max_Gap_Length: 最大连续Gap长度",
                "# TRF_Check: TRF检查结果",
                "# Tandem_Repeats: 符合过滤条件的串联重复数量",
                "# Filter_Status: 最终过滤状态 (PASS/FILTER)",
                "# Filter_Reason: 过滤原因",
                "#"
            ]
